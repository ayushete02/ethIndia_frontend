...
export default function certificates() {
  return (
    <div>
    {/* <div class="m-200 flex items-center justify-center">
  ...
  <div class="modal-dialog modal-sm relative w-auto pointer-events-none">
    <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
      ...
      <div class="modal-body relative p-4">
        ...
        <img class=" rounded-lg flex flex-col items-center max-w-full h-auto " src="https://mdbootstrap.com/img/new/slides/041.jpg" alt="" />
      </div>
